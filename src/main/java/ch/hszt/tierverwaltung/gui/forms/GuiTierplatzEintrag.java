...
public class GuiTierplatzEintrag {
	...
	private TierplatzDataMapper tdm;
	private MainGui gui;
	...
	private void loadPetSpace() {
		suitableForCbx.setSelectedIndex(petSpace.getGeeignetFuerTierID());
		
		cageSizeTxt.setText(Integer.toString(petSpace.getGroesse()));
